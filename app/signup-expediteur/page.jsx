          ...
          <div className="flex flex-col grow items-start max-md:mt-10 max-md:max-w-full">
            <div className="flex gap-5 self-stretch text-base font-semibold text-center max-md:flex-wrap">
              ...
              <button
                ...
                className="justify-center px-3.5 py-6 rounded-md border border-solid text-cyan-800 bg-white border-cyan-800"
              >
