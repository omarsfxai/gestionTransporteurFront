...
const CountrySelect = () => {
  const [selectedCountry, setSelectedCountry] = useState("FR"); // Sélectionne la France par défaut
    ...
    <div>
      <div className="flex gap-5 justify-between items-start px-5 py-3 mt-8 max-w-full whitespace-nowrap bg-white rounded-lg border border-gray-300 border-solid w-[360px]">
        <div className="flex flex-col">
          ...
          <div>
            <select id="country-select" onChange={handleChange} value={selectedCountry}>
