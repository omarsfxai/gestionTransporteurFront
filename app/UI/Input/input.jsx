...
function Input({ label, placeholder = " ", register, type, value, onChange }) {
  ...
  return (
    <div className="flex flex-col justify-center px-5 py-2.5 mt-2 max-w-full bg-white rounded-lg border border-gray-300 border-solid w-[360px]">
      ...
      <div className="flex items-center gap-5 justify-between text-sm leading-5 whitespace-nowrap text-stone-900 relative">
        {type === "password" && (
